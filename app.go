...
// CosmicApp extends ABCI application
...
func NewCosmicApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	invCheckPeriod uint, baseAppOptions ...func(*bam.BaseApp)) *CosmicApp {
	...
	app.mm.SetOrderInitGenesis(
		...
		slashing.ModuleName, nft.ModuleName, mint.ModuleName, supply.ModuleName,
