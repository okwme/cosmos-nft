...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a NFTd testnet",
...
Example:
	nftd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "nftd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "nftcli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	nftConfig := srvconfig.DefaultConfig()
	nftConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to NFT
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		nftConfigFilePath := filepath.Join(nodeDir, "config/nftd.toml")
		srvconfig.WriteConfigFile(nftConfigFilePath, nftConfig)
	}
