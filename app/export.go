...
// ExportAppStateAndValidators export the state of nft for a genesis file
...
func (app *CosmicApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
